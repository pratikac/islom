...
plt.plot(index, accelAngle, 'r-', label='Accel angle')
plt.plot(index, gRate, 'b-', label='Gyro rate')
plt.plot(index, kalmanAngle, 'g-', label='Kalman angle')
plt.legend( ('Accel angle', 'Gyro rate', 'Kalman angle'), loc="upper left")
ax.set_ylim((-180,180))
