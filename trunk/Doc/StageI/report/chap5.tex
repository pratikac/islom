...
% \begin{figure}[!h]
% \centering
% \subfloat[High frequency input]{\label{fig:5_kalman_highfreq}\includegraphics[scale=1]{fig/kalman_highfreq.pdf}}
% \subfloat[Gyro drift effect]{\label{fig:5_kalman_gyrodrift}\includegraphics[scale=1]{fig/kalman_drift.pdf}}
% \caption{Kalman filter for various inputs}
% \end{figure}
\begin{figure}[!h]
\centering
